// Figma node 1080:54456 — search-filter bar
// Search input: bg-surface-white rounded-[100px] pl-[16px] pr-[8px] py-[8px] gap-[8px]
...
// New account btn: bg-brand-action rounded-[12px] pl-[10px] pr-[12px] py-[8px] gap-[8px]
// Filters container gap: gap-[12px]
    ...
    <div className="flex items-center justify-between gap-4 w-full">
      ...
      <div className="w-1/2 min-w-0 bg-surface-white rounded-[100px] flex gap-[8px] items-center pl-[16px] pr-[8px] py-[8px]">
        <input
          ...
          placeholder='Ask about your accounts... "highest value"'
      ...
      <div className="flex items-center gap-[12px] shrink-0">
        ...
        >
          ...
          <span className="font-crm text-body-3 text-content-invert whitespace-nowrap">New account</span>
        </button>
      </div>
    </div>
  )
